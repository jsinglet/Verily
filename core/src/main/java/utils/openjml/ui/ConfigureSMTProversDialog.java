...
import utils.openjml.ProverValidator;
...
public class ConfigureSMTProversDialog extends JDialog {
    ...
    public ConfigureSMTProversDialog() {
        ...
        JLabel lblNewLabel_1 = new JLabel(MessageUtil.getMessage(ApplicationMessages.ApplicationMessageKey.MsgInvalidProverConfiguration));
        ...
        comboProver.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                lblExecutable.setText(String.format(MessageUtil
                        .getMessage(ApplicationMessages.ApplicationMessageKey.MsgProverExecutable),
    ...
    private void setErrorState() {
        statusMsg.setText(String.format(MessageUtil
                .getMessage(ApplicationMessages.ApplicationMessageKey.MsgInvalidProverExecutable),
    ...
    private void setSuccessState() {
        statusMsg.setText(String.format(MessageUtil
                .getMessage(ApplicationMessages.ApplicationMessageKey.MsgValidProverExecutable),
                comboProver.getSelectedItem().toString().split(" ")[0]));
