...
public class VerilyMethodTest {
    ...
    public void testEquals() throws Exception {
        ...
        VerilyMethod m1 = new VerilyMethod("myMethod", fp1, null,0);
        VerilyMethod m2 = new VerilyMethod("myMethod", fp2, null,0);
        VerilyMethod m3 = new VerilyMethod("myMethod", fp3, null,0);
        VerilyMethod m4 = new VerilyMethod("myMethod", fp4, null,0);
        VerilyMethod m5 = new VerilyMethod("myMethod", fp5, null,0);
        VerilyMethod m6 = new VerilyMethod("myMethod1", fp1, null,0);
